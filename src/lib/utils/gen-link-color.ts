export const genLinkColor = {
	red: "[&>a]:font-black [&>button]:font-black [&>a]:text-red-500 [&>a]:hover:text-red-300 [&>a]:active:text-red-600 [&>button]:text-red-500 [&>button]:hover:text-red-300 [&>button]:active:text-red-600",
	orange: "[&>a]:font-black [&>button]:font-black [&>a]:text-orange-500 [&>a]:hover:text-orange-300 [&>a]:active:text-orange-600 [&>button]:text-orange-500 [&>button]:hover:text-orange-300 [&>button]:active:text-orange-600",
	amber: "[&>a]:font-black [&>button]:font-black [&>a]:text-amber-500 [&>a]:hover:text-amber-300 [&>a]:active:text-amber-600 [&>button]:text-amber-500 [&>button]:hover:text-amber-300 [&>button]:active:text-amber-600",
	yellow: "[&>a]:font-black [&>button]:font-black [&>a]:text-yellow-500 [&>a]:hover:text-yellow-300 [&>a]:active:text-yellow-600 [&>button]:text-yellow-500 [&>button]:hover:text-yellow-300 [&>button]:active:text-yellow-600",
	lime: "[&>a]:font-black [&>button]:font-black [&>a]:text-lime-500 [&>a]:hover:text-lime-300 [&>a]:active:text-lime-600 [&>button]:text-lime-500 [&>button]:hover:text-lime-300 [&>button]:active:text-lime-600",
	green: "[&>a]:font-black [&>button]:font-black [&>a]:text-green-500 [&>a]:hover:text-green-300 [&>a]:active:text-green-600 [&>button]:text-green-500 [&>button]:hover:text-green-300 [&>button]:active:text-green-600",
	emerald:
		"[&>a]:font-black [&>button]:font-black [&>a]:text-emerald-500 [&>a]:hover:text-emerald-300 [&>a]:active:text-emerald-600 [&>button]:text-emerald-500 [&>button]:hover:text-emerald-300 [&>button]:active:text-emerald-600",
	teal: "[&>a]:font-black [&>button]:font-black [&>a]:text-teal-500 [&>a]:hover:text-teal-300 [&>a]:active:text-teal-600 [&>button]:text-teal-500 [&>button]:hover:text-teal-300 [&>button]:active:text-teal-600",
	cyan: "[&>a]:font-black [&>button]:font-black [&>a]:text-cyan-500 [&>a]:hover:text-cyan-300 [&>a]:active:text-cyan-600 [&>button]:text-cyan-500 [&>button]:hover:text-cyan-300 [&>button]:active:text-cyan-600",
	sky: "[&>a]:font-black [&>button]:font-black [&>a]:text-sky-500 [&>a]:hover:text-sky-300 [&>a]:active:text-sky-600 [&>button]:text-sky-500 [&>button]:hover:text-sky-300 [&>button]:active:text-sky-600",
	blue: "[&>a]:font-black [&>button]:font-black [&>a]:text-blue-500 [&>a]:hover:text-blue-300 [&>a]:active:text-blue-600 [&>button]:text-blue-500 [&>button]:hover:text-blue-300 [&>button]:active:text-blue-600",
	indigo: "[&>a]:font-black [&>button]:font-black [&>a]:text-indigo-500 [&>a]:hover:text-indigo-300 [&>a]:active:text-indigo-600 [&>button]:text-indigo-500 [&>button]:hover:text-indigo-300 [&>button]:active:text-indigo-600",
	violet: "[&>a]:font-black [&>button]:font-black [&>a]:text-violet-500 [&>a]:hover:text-violet-300 [&>a]:active:text-violet-600 [&>button]:text-violet-500 [&>button]:hover:text-violet-300 [&>button]:active:text-violet-600",
	purple: "[&>a]:font-black [&>button]:font-black [&>a]:text-purple-500 [&>a]:hover:text-purple-300 [&>a]:active:text-purple-600 [&>button]:text-purple-500 [&>button]:hover:text-purple-300 [&>button]:active:text-purple-600",
	fuchsia:
		"[&>a]:font-black [&>button]:font-black [&>a]:text-fuchsia-500 [&>a]:hover:text-fuchsia-300 [&>a]:active:text-fuchsia-600 [&>button]:text-fuchsia-500 [&>button]:hover:text-fuchsia-300 [&>button]:active:text-fuchsia-600",
	pink: "[&>a]:font-black [&>button]:font-black [&>a]:text-pink-500 [&>a]:hover:text-pink-300 [&>a]:active:text-pink-600 [&>button]:text-pink-500 [&>button]:hover:text-pink-300 [&>button]:active:text-pink-600",
