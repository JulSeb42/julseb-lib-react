...
export const inputPinPreview: ComponentPreview<ILibInputPin> = {
	...
	component: InputPin,
	category: "components",
	import: "InputPin", // import Component (ex: Skeleton)
	additionalImports: [], // import OtherComponent (ex: SkeletonCard)
	optionalImports: [], // import ComponentItem (ex: AccordionItem) => to build with children instead of prop on component
	propsImport: "ILibInputPin", // import ILibComponent (ex: ILibAccordion)
	additionalTypeImports: ["LibValueInputPin"], // import LibComponentItem (ex: LibAccordionItem)
