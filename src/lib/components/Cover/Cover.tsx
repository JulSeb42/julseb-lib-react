 ...
 * @prop {React.Ref<any>} [props.ref] - Ref to the cover element.
	...
	return (
		...
		>
			<Image
				src={img}
				alt={alt}
				className="top-0 left-0 z-0 fixed w-full h-full image"
			/>
			...
			<div className="top-0 left-0 z-20 relative w-fit h-fit">
				{children}
			</div>
		</Element>
	)
