	...
	return (
		<Flexbox
			...
			className={clsx(
				...
				isShiny && [
					"relative overflow-hidden",
					"before:absolute before:-top-50 before:-bottom-50 before:bg-white before:opacity-70 before:blur-[20px] before:w-25 before:-skew-15 before:animate-[shine_2000ms_ease-in-out_infinite]",
				],
