...
import { Input, cssVariables } from "../../.."
...
describe("<Input />", () => {
    ...
    it("renders several props", () => {
        ...
        cy.dataTest("testid.HelperBottom.IconContainer")
            .should("exist")
            .should("have.class", "HelperBottom__IconContainer")
        cy.dataTest("testid.HelperBottom.IconContainer.Icon")
            .should("exist")
            .should("have.class", "HelperBottom__IconContainer__Icon")
        ...
        cy.dataTest("testid.ValidationHelper.IconContainer")
            .should("exist")
            .should("have.class", "ValidationHelper__IconContainer")
        cy.dataTest("testid.ValidationHelper.IconContainer.Icon")
            .should("exist")
            .should("have.class", "ValidationHelper__IconContainer__Icon")
        cy.dataTest("testid.ValidationHelper.Text")
            .should("exist")
            .should("have.class", "ValidationHelper__Text")
    ...
    it("renders an input color", () => {
        ...
        cy.dataTest()
            ...
            .should(
                "have.css",
                "background-color",
                cssVariables.colors.dark.background.rgb
            )
