export const KyFlag: FC<{ width?: number }> = ({ width = 16 }) => {
	return (
		<svg
		...
		>
			...
			>
				...
				<use xlinkHref="#e" width="100%" height="100%" />
				<use xlinkHref="#f" width="100%" height="100%" />
			...
			>
				...
				<use xlinkHref="#h" width="100%" height="100%" x="90.1" />
				<use
					xlinkHref="#h"
					width="100%"
					height="100%"
