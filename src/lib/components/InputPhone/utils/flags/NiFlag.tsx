export const NiFlag: FC<{ width?: number }> = ({ width = 16 }) => {
	return (
		<svg
		...
		>
			...
			<g clipPath="url(#c)" transform="matrix(.8 0 0 .8 -80 0)">
				...
				<g fill="#ccd11e">
					...
					<use xlinkHref="#t" width="100%" height="100%" x="-15.3" />
					<g fill="#c6cb24">
						<path
							fill="url(#u)"
				...
				<g id="A">
					...
					/>
					<use xlinkHref="#z" width="100%" height="100%" y="-1.3" />
					<use xlinkHref="#z" width="100%" height="100%" y="-2.6" />
				</g>
				<use xlinkHref="#A" width="100%" height="100%" y="-3.9" />
				<use xlinkHref="#A" width="100%" height="100%" y="-7.7" />
				<path
					fill="#97c924"
