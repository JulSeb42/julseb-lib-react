...
type MarginRef2 =
	...
	| "px"
	| "reverse"
type CustomRef1 = "foreground"
type CustomRef2 = "1" | "2" | "3" | "4" | "5"
type CustomRef3 = "foreground"
type CustomRef4 =
	| "accent"
	| "accent-foreground"
	| "border"
	...
	| "primary-foreground"
	| "ring"
type CustomRef5 = "foreground"
type CustomRef6 = "1" | "2" | "3" | "4" | "5"
type CustomRef7 = "foreground"
type CustomRef8 = "foreground"
type CustomRef9 = "1" | "2" | "3" | "4" | "5"
type CustomRef10 = "foreground"
type CustomRef11 = "foreground"
type CustomRef12 = "1" | "2" | "3" | "4" | "5"
type CustomRef13 = "foreground"
type CustomRef14 = "foreground"
type CustomRef15 = "1" | "2" | "3" | "4" | "5"
type CustomRef16 = "foreground"
type CustomRef17 = "foreground"
type CustomRef18 = "1" | "2" | "3" | "4" | "5"
type CustomRef19 = "foreground"
type CustomRef20 = "foreground"
type CustomRef21 = "foreground"
type CustomRef22 = "1" | "2" | "3" | "4" | "5"
type CustomRef23 = "foreground"
type CustomRef24 = "foreground"
type CustomRef25 = "foreground"
type CustomRef26 = "foreground"
type CustomRef27 = "foreground"
type CustomRef28 = "foreground"
type CustomRef29 = "foreground"
type CustomRef30 = "1" | "2" | "3" | "4" | "5"
type CustomRef31 = "foreground"
type CustomRef32 = "foreground"
type CustomRef33 = "foreground"
type CustomRef34 = "foreground"
type CustomRef35 = "foreground"
type CustomRef36 = "foreground"
type CustomRef37 = "foreground"
type CustomRef38 = "1" | "2" | "3" | "4" | "5"
type CustomRef39 = "foreground"
type CustomRef40 = "foreground"
type CustomRef41 = "foreground"
type CustomRef42 = "foreground"
type CustomRef43 = "foreground"
type CustomRef44 = "foreground"
type CustomRef45 = "foreground"
type CustomRef46 = "1" | "2" | "3" | "4" | "5"
type CustomRef47 = "foreground"
type CustomRef48 = "foreground"
type CustomRef49 = "foreground"
type CustomRef50 = "foreground"
type CustomRef51 = "foreground"
type CustomRef52 = "left" | "right"
type CustomRef53 = "left" | "right"
type CustomRef54 = "foreground"
type CustomRef55 = "1" | "2" | "3" | "4" | "5"
type CustomRef56 = "foreground"
type CustomRef57 = "foreground"
type CustomRef58 = "1" | "2" | "3" | "4" | "5"
type CustomRef59 = "foreground"
type CustomRef60 = "foreground"
type CustomRef61 = "1" | "2" | "3" | "4" | "5"
type CustomRef62 = "foreground"
type CustomRef63 = "foreground"
type CustomRef64 = "foreground"
type CustomRef65 = "foreground"
type CustomRef66 = "foreground"
type CustomRef67 = "1" | "2" | "3" | "4" | "5"
type CustomRef68 = "foreground"
type CustomRef69 = "foreground"
type CustomRef70 = "foreground"
type CustomRef71 = "foreground"
type CustomRef72 = "foreground"
type CustomRef73 = "foreground"
type CustomRef74 = "1" | "2" | "3" | "4" | "5"
type CustomRef75 = "foreground"
type CustomRef76 = "foreground"
type CustomRef77 = "1" | "2" | "3" | "4" | "5"
type CustomRef78 = "foreground"
type CustomRef79 = "foreground"
type CustomRef80 = "1" | "2" | "3" | "4" | "5"
type CustomRef81 = "foreground"
type CustomRef82 = "foreground"
type CustomRef83 = "foreground"
type CustomRef84 = "1" | "2" | "3" | "4" | "5"
type CustomRef85 = "foreground"
type CustomRef86 = "foreground"
type CustomRef87 = "foreground"
type CustomRef88 = "1" | "2" | "3" | "4" | "5"
type CustomRef89 = "foreground"
type CustomRef90 =
	| "0"
	| "5"
	| "10"
	...
	| "100"
	| "translate-full"
type CustomRef91 = "bottom" | "center" | "left" | "right" | "top"
type CustomRef92 =
	| "0"
	| "0%"
	| "0.5"
...
type CustomRef93 =
	...
	| "farthest-corner"
	| "farthest-side"
type CustomRef94 = "0" | "1" | "2" | "3" | "6" | "12" | "45" | "90" | "180"
type CustomRef95 = "circle" | "ellipse"
type CustomRef96 =
	| "accent"
	| "background"
	| "border"
	...
	| "transparent"
	| TailwindGlobalColor
type CustomRef97 = "in" | "out"
type CustomRef98 = "bottom" | "left" | "right" | "top"
type CustomRef99 = "bottom" | "left" | "right" | "top"
type CustomRef100 = "in" | "out"
type OrderRef1 =
	| "1"
	| "2"
	| "3"
...
type BorderWidthRef9 = "foreground"
type BorderWidthRef10 = "0" | "2" | "4" | "8" | "reverse"
type BorderWidthRef11 = "0" | "2" | "4" | "8" | "reverse"
type BorderWidthRef12 =
	| "0"
	| "2"
	| "4"
	| "8"
...
type FillRef3 = "backwards" | "both" | "forwards" | "none"
...
type BoxShadowRef12 = "foreground"
type BoxShadowRef13 = "1" | "2" | "3" | "4" | "5"
type BoxShadowRef14 = "foreground"
type BoxShadowRef15 = "foreground"
type BoxShadowRef16 = "foreground"
type BoxShadowRef17 = "foreground"
type BoxShadowRef18 = "foreground"
type BoxShadowRef19 =
	| "0"
	| "1"
	| "2"
...
type CustomMaskconicfromaccentLiteral = `mask-conic-from-accent-${CustomRef1}`
type CustomMaskconicfromaccentLiteralWithSign =
	| CustomMaskconicfromaccentLiteral
	| `-${CustomMaskconicfromaccentLiteral}`
type CustomMaskconicfromchartLiteral = `mask-conic-from-chart-${CustomRef2}`
type CustomMaskconicfromchartLiteralWithSign =
	| CustomMaskconicfromchartLiteral
	| `-${CustomMaskconicfromchartLiteral}`
type CustomMaskconicfromprimaryLiteral = `mask-conic-from-primary-${CustomRef3}`
type CustomMaskconicfromprimaryLiteralWithSign =
	| CustomMaskconicfromprimaryLiteral
	| `-${CustomMaskconicfromprimaryLiteral}`
type CustomMaskconicfromsidebarLiteral = `mask-conic-from-sidebar-${CustomRef4}`
type CustomMaskconicfromsidebarLiteralWithSign =
	| CustomMaskconicfromsidebarLiteral
	| `-${CustomMaskconicfromsidebarLiteral}`
type CustomMaskconictoaccentLiteral = `mask-conic-to-accent-${CustomRef5}`
type CustomMaskconictoaccentLiteralWithSign =
	| CustomMaskconictoaccentLiteral
	| `-${CustomMaskconictoaccentLiteral}`
type CustomMaskconictochartLiteral = `mask-conic-to-chart-${CustomRef6}`
type CustomMaskconictochartLiteralWithSign =
	| CustomMaskconictochartLiteral
	| `-${CustomMaskconictochartLiteral}`
type CustomMaskconictoprimaryLiteral = `mask-conic-to-primary-${CustomRef7}`
type CustomMaskconictoprimaryLiteralWithSign =
	| CustomMaskconictoprimaryLiteral
	| `-${CustomMaskconictoprimaryLiteral}`
type CustomMaskconictosidebarLiteral = `mask-conic-to-sidebar-${CustomRef4}`
type CustomMaskconictosidebarLiteralWithSign =
	| CustomMaskconictosidebarLiteral
	| `-${CustomMaskconictosidebarLiteral}`
type CustomMasklinearfromaccentLiteral = `mask-linear-from-accent-${CustomRef8}`
type CustomMasklinearfromaccentLiteralWithSign =
	| CustomMasklinearfromaccentLiteral
	| `-${CustomMasklinearfromaccentLiteral}`
type CustomMasklinearfromchartLiteral = `mask-linear-from-chart-${CustomRef9}`
type CustomMasklinearfromchartLiteralWithSign =
	| CustomMasklinearfromchartLiteral
	| `-${CustomMasklinearfromchartLiteral}`
type CustomMasklinearfromprimaryLiteral =
	`mask-linear-from-primary-${CustomRef10}`
type CustomMasklinearfromprimaryLiteralWithSign =
	| CustomMasklinearfromprimaryLiteral
	| `-${CustomMasklinearfromprimaryLiteral}`
type CustomMasklinearfromsidebarLiteral =
	`mask-linear-from-sidebar-${CustomRef4}`
type CustomMasklinearfromsidebarLiteralWithSign =
	| CustomMasklinearfromsidebarLiteral
	| `-${CustomMasklinearfromsidebarLiteral}`
type CustomMasklineartoaccentLiteral = `mask-linear-to-accent-${CustomRef11}`
type CustomMasklineartoaccentLiteralWithSign =
	| CustomMasklineartoaccentLiteral
	| `-${CustomMasklineartoaccentLiteral}`
type CustomMasklineartochartLiteral = `mask-linear-to-chart-${CustomRef12}`
type CustomMasklineartochartLiteralWithSign =
	| CustomMasklineartochartLiteral
	| `-${CustomMasklineartochartLiteral}`
type CustomMasklineartoprimaryLiteral = `mask-linear-to-primary-${CustomRef13}`
type CustomMasklineartoprimaryLiteralWithSign =
	| CustomMasklineartoprimaryLiteral
	| `-${CustomMasklineartoprimaryLiteral}`
type CustomMasklineartosidebarLiteral = `mask-linear-to-sidebar-${CustomRef4}`
type CustomMasklineartosidebarLiteralWithSign =
	| CustomMasklineartosidebarLiteral
	| `-${CustomMasklineartosidebarLiteral}`
type CustomMaskbfromaccentLiteral = `mask-b-from-accent-${CustomRef14}`
type CustomMaskbfromaccentLiteralWithSign =
	| CustomMaskbfromaccentLiteral
	| `-${CustomMaskbfromaccentLiteral}`
type CustomMaskbfromchartLiteral = `mask-b-from-chart-${CustomRef15}`
type CustomMaskbfromchartLiteralWithSign =
	| CustomMaskbfromchartLiteral
	| `-${CustomMaskbfromchartLiteral}`
type CustomMaskbfromprimaryLiteral = `mask-b-from-primary-${CustomRef16}`
type CustomMaskbfromprimaryLiteralWithSign =
	| CustomMaskbfromprimaryLiteral
	| `-${CustomMaskbfromprimaryLiteral}`
type CustomMaskbfromsidebarLiteral = `mask-b-from-sidebar-${CustomRef4}`
type CustomMaskbfromsidebarLiteralWithSign =
	| CustomMaskbfromsidebarLiteral
	| `-${CustomMaskbfromsidebarLiteral}`
type CustomMaskbtoaccentLiteral = `mask-b-to-accent-${CustomRef17}`
type CustomMaskbtoaccentLiteralWithSign =
	| CustomMaskbtoaccentLiteral
	| `-${CustomMaskbtoaccentLiteral}`
type CustomMaskbtochartLiteral = `mask-b-to-chart-${CustomRef18}`
type CustomMaskbtochartLiteralWithSign =
	| CustomMaskbtochartLiteral
	| `-${CustomMaskbtochartLiteral}`
type CustomMaskbtoprimaryLiteral = `mask-b-to-primary-${CustomRef19}`
type CustomMaskbtoprimaryLiteralWithSign =
	| CustomMaskbtoprimaryLiteral
	| `-${CustomMaskbtoprimaryLiteral}`
type CustomMaskbtosidebarLiteral = `mask-b-to-sidebar-${CustomRef4}`
type CustomMaskbtosidebarLiteralWithSign =
	| CustomMaskbtosidebarLiteral
	| `-${CustomMaskbtosidebarLiteral}`
type CustomMasklfromaccentLiteral = `mask-l-from-accent-${CustomRef20}`
type CustomMasklfromaccentLiteralWithSign =
	| CustomMasklfromaccentLiteral
	| `-${CustomMasklfromaccentLiteral}`
type CustomMasklfromcardLiteral = `mask-l-from-card-${CustomRef21}`
type CustomMasklfromcardLiteralWithSign =
	| CustomMasklfromcardLiteral
	| `-${CustomMasklfromcardLiteral}`
type CustomMasklfromchartLiteral = `mask-l-from-chart-${CustomRef22}`
type CustomMasklfromchartLiteralWithSign =
	| CustomMasklfromchartLiteral
	| `-${CustomMasklfromchartLiteral}`
type CustomMasklfromdestructiveLiteral =
	`mask-l-from-destructive-${CustomRef23}`
type CustomMasklfromdestructiveLiteralWithSign =
	| CustomMasklfromdestructiveLiteral
	| `-${CustomMasklfromdestructiveLiteral}`
type CustomMasklfrommutedLiteral = `mask-l-from-muted-${CustomRef24}`
type CustomMasklfrommutedLiteralWithSign =
	| CustomMasklfrommutedLiteral
	| `-${CustomMasklfrommutedLiteral}`
type CustomMasklfrompopoverLiteral = `mask-l-from-popover-${CustomRef25}`
type CustomMasklfrompopoverLiteralWithSign =
	| CustomMasklfrompopoverLiteral
	| `-${CustomMasklfrompopoverLiteral}`
type CustomMasklfromprimaryLiteral = `mask-l-from-primary-${CustomRef26}`
type CustomMasklfromprimaryLiteralWithSign =
	| CustomMasklfromprimaryLiteral
	| `-${CustomMasklfromprimaryLiteral}`
type CustomMasklfromsecondaryLiteral = `mask-l-from-secondary-${CustomRef27}`
type CustomMasklfromsecondaryLiteralWithSign =
	| CustomMasklfromsecondaryLiteral
	| `-${CustomMasklfromsecondaryLiteral}`
type CustomMasklfromsidebarLiteral = `mask-l-from-sidebar-${CustomRef4}`
type CustomMasklfromsidebarLiteralWithSign =
	| CustomMasklfromsidebarLiteral
	| `-${CustomMasklfromsidebarLiteral}`
type CustomMaskltoaccentLiteral = `mask-l-to-accent-${CustomRef28}`
type CustomMaskltoaccentLiteralWithSign =
	| CustomMaskltoaccentLiteral
	| `-${CustomMaskltoaccentLiteral}`
type CustomMaskltocardLiteral = `mask-l-to-card-${CustomRef29}`
type CustomMaskltocardLiteralWithSign =
	| CustomMaskltocardLiteral
	| `-${CustomMaskltocardLiteral}`
type CustomMaskltochartLiteral = `mask-l-to-chart-${CustomRef30}`
type CustomMaskltochartLiteralWithSign =
	| CustomMaskltochartLiteral
	| `-${CustomMaskltochartLiteral}`
type CustomMaskltodestructiveLiteral = `mask-l-to-destructive-${CustomRef31}`
type CustomMaskltodestructiveLiteralWithSign =
	| CustomMaskltodestructiveLiteral
	| `-${CustomMaskltodestructiveLiteral}`
type CustomMaskltomutedLiteral = `mask-l-to-muted-${CustomRef32}`
type CustomMaskltomutedLiteralWithSign =
	| CustomMaskltomutedLiteral
	| `-${CustomMaskltomutedLiteral}`
type CustomMaskltopopoverLiteral = `mask-l-to-popover-${CustomRef33}`
type CustomMaskltopopoverLiteralWithSign =
	| CustomMaskltopopoverLiteral
	| `-${CustomMaskltopopoverLiteral}`
type CustomMaskltoprimaryLiteral = `mask-l-to-primary-${CustomRef34}`
type CustomMaskltoprimaryLiteralWithSign =
	| CustomMaskltoprimaryLiteral
	| `-${CustomMaskltoprimaryLiteral}`
type CustomMaskltosecondaryLiteral = `mask-l-to-secondary-${CustomRef35}`
type CustomMaskltosecondaryLiteralWithSign =
	| CustomMaskltosecondaryLiteral
	| `-${CustomMaskltosecondaryLiteral}`
type CustomMaskltosidebarLiteral = `mask-l-to-sidebar-${CustomRef4}`
type CustomMaskltosidebarLiteralWithSign =
	| CustomMaskltosidebarLiteral
	| `-${CustomMaskltosidebarLiteral}`
type CustomMaskrfromaccentLiteral = `mask-r-from-accent-${CustomRef36}`
type CustomMaskrfromaccentLiteralWithSign =
	| CustomMaskrfromaccentLiteral
	| `-${CustomMaskrfromaccentLiteral}`
type CustomMaskrfromcardLiteral = `mask-r-from-card-${CustomRef37}`
type CustomMaskrfromcardLiteralWithSign =
	| CustomMaskrfromcardLiteral
	| `-${CustomMaskrfromcardLiteral}`
type CustomMaskrfromchartLiteral = `mask-r-from-chart-${CustomRef38}`
type CustomMaskrfromchartLiteralWithSign =
	| CustomMaskrfromchartLiteral
	| `-${CustomMaskrfromchartLiteral}`
type CustomMaskrfromdestructiveLiteral =
	`mask-r-from-destructive-${CustomRef39}`
type CustomMaskrfromdestructiveLiteralWithSign =
	| CustomMaskrfromdestructiveLiteral
	| `-${CustomMaskrfromdestructiveLiteral}`
type CustomMaskrfrommutedLiteral = `mask-r-from-muted-${CustomRef40}`
type CustomMaskrfrommutedLiteralWithSign =
	| CustomMaskrfrommutedLiteral
	| `-${CustomMaskrfrommutedLiteral}`
type CustomMaskrfrompopoverLiteral = `mask-r-from-popover-${CustomRef41}`
type CustomMaskrfrompopoverLiteralWithSign =
	| CustomMaskrfrompopoverLiteral
	| `-${CustomMaskrfrompopoverLiteral}`
type CustomMaskrfromprimaryLiteral = `mask-r-from-primary-${CustomRef42}`
type CustomMaskrfromprimaryLiteralWithSign =
	| CustomMaskrfromprimaryLiteral
	| `-${CustomMaskrfromprimaryLiteral}`
type CustomMaskrfromsecondaryLiteral = `mask-r-from-secondary-${CustomRef43}`
type CustomMaskrfromsecondaryLiteralWithSign =
	| CustomMaskrfromsecondaryLiteral
	| `-${CustomMaskrfromsecondaryLiteral}`
type CustomMaskrfromsidebarLiteral = `mask-r-from-sidebar-${CustomRef4}`
type CustomMaskrfromsidebarLiteralWithSign =
	| CustomMaskrfromsidebarLiteral
	| `-${CustomMaskrfromsidebarLiteral}`
type CustomMaskrtoaccentLiteral = `mask-r-to-accent-${CustomRef44}`
type CustomMaskrtoaccentLiteralWithSign =
	| CustomMaskrtoaccentLiteral
	| `-${CustomMaskrtoaccentLiteral}`
type CustomMaskrtocardLiteral = `mask-r-to-card-${CustomRef45}`
type CustomMaskrtocardLiteralWithSign =
	| CustomMaskrtocardLiteral
	| `-${CustomMaskrtocardLiteral}`
type CustomMaskrtochartLiteral = `mask-r-to-chart-${CustomRef46}`
type CustomMaskrtochartLiteralWithSign =
	| CustomMaskrtochartLiteral
	| `-${CustomMaskrtochartLiteral}`
type CustomMaskrtodestructiveLiteral = `mask-r-to-destructive-${CustomRef47}`
type CustomMaskrtodestructiveLiteralWithSign =
	| CustomMaskrtodestructiveLiteral
	| `-${CustomMaskrtodestructiveLiteral}`
type CustomMaskrtomutedLiteral = `mask-r-to-muted-${CustomRef48}`
type CustomMaskrtomutedLiteralWithSign =
	| CustomMaskrtomutedLiteral
	| `-${CustomMaskrtomutedLiteral}`
type CustomMaskrtopopoverLiteral = `mask-r-to-popover-${CustomRef49}`
type CustomMaskrtopopoverLiteralWithSign =
	| CustomMaskrtopopoverLiteral
	| `-${CustomMaskrtopopoverLiteral}`
type CustomMaskrtoprimaryLiteral = `mask-r-to-primary-${CustomRef50}`
type CustomMaskrtoprimaryLiteralWithSign =
	| CustomMaskrtoprimaryLiteral
	| `-${CustomMaskrtoprimaryLiteral}`
type CustomMaskrtosecondaryLiteral = `mask-r-to-secondary-${CustomRef51}`
type CustomMaskrtosecondaryLiteralWithSign =
	| CustomMaskrtosecondaryLiteral
	| `-${CustomMaskrtosecondaryLiteral}`
type CustomMaskrtosidebarLiteral = `mask-r-to-sidebar-${CustomRef4}`
type CustomMaskrtosidebarLiteralWithSign =
	| CustomMaskrtosidebarLiteral
	| `-${CustomMaskrtosidebarLiteral}`
type CustomMaskradialatbottomLiteral = `mask-radial-at-bottom-${CustomRef52}`
type CustomMaskradialatbottomLiteralWithSign =
	| CustomMaskradialatbottomLiteral
	| `-${CustomMaskradialatbottomLiteral}`
type CustomMaskradialattopLiteral = `mask-radial-at-top-${CustomRef53}`
type CustomMaskradialattopLiteralWithSign =
	| CustomMaskradialattopLiteral
	| `-${CustomMaskradialattopLiteral}`
type CustomMaskradialfromaccentLiteral =
	`mask-radial-from-accent-${CustomRef54}`
type CustomMaskradialfromaccentLiteralWithSign =
	| CustomMaskradialfromaccentLiteral
	| `-${CustomMaskradialfromaccentLiteral}`
type CustomMaskradialfromchartLiteral = `mask-radial-from-chart-${CustomRef55}`
type CustomMaskradialfromchartLiteralWithSign =
	| CustomMaskradialfromchartLiteral
	| `-${CustomMaskradialfromchartLiteral}`
type CustomMaskradialfromprimaryLiteral =
	`mask-radial-from-primary-${CustomRef56}`
type CustomMaskradialfromprimaryLiteralWithSign =
	| CustomMaskradialfromprimaryLiteral
	| `-${CustomMaskradialfromprimaryLiteral}`
type CustomMaskradialfromsidebarLiteral =
	`mask-radial-from-sidebar-${CustomRef4}`
type CustomMaskradialfromsidebarLiteralWithSign =
	| CustomMaskradialfromsidebarLiteral
	| `-${CustomMaskradialfromsidebarLiteral}`
type CustomMaskradialtoaccentLiteral = `mask-radial-to-accent-${CustomRef57}`
type CustomMaskradialtoaccentLiteralWithSign =
	| CustomMaskradialtoaccentLiteral
	| `-${CustomMaskradialtoaccentLiteral}`
type CustomMaskradialtochartLiteral = `mask-radial-to-chart-${CustomRef58}`
type CustomMaskradialtochartLiteralWithSign =
	| CustomMaskradialtochartLiteral
	| `-${CustomMaskradialtochartLiteral}`
type CustomMaskradialtoprimaryLiteral = `mask-radial-to-primary-${CustomRef59}`
type CustomMaskradialtoprimaryLiteralWithSign =
	| CustomMaskradialtoprimaryLiteral
	| `-${CustomMaskradialtoprimaryLiteral}`
type CustomMaskradialtosidebarLiteral = `mask-radial-to-sidebar-${CustomRef4}`
type CustomMaskradialtosidebarLiteralWithSign =
	| CustomMaskradialtosidebarLiteral
	| `-${CustomMaskradialtosidebarLiteral}`
type CustomMasktfromaccentLiteral = `mask-t-from-accent-${CustomRef60}`
type CustomMasktfromaccentLiteralWithSign =
	| CustomMasktfromaccentLiteral
	| `-${CustomMasktfromaccentLiteral}`
type CustomMasktfromchartLiteral = `mask-t-from-chart-${CustomRef61}`
type CustomMasktfromchartLiteralWithSign =
	| CustomMasktfromchartLiteral
	| `-${CustomMasktfromchartLiteral}`
type CustomMasktfromdestructiveLiteral =
	`mask-t-from-destructive-${CustomRef62}`
type CustomMasktfromdestructiveLiteralWithSign =
	| CustomMasktfromdestructiveLiteral
	| `-${CustomMasktfromdestructiveLiteral}`
type CustomMasktfrommutedLiteral = `mask-t-from-muted-${CustomRef63}`
type CustomMasktfrommutedLiteralWithSign =
	| CustomMasktfrommutedLiteral
	| `-${CustomMasktfrommutedLiteral}`
type CustomMasktfromprimaryLiteral = `mask-t-from-primary-${CustomRef64}`
type CustomMasktfromprimaryLiteralWithSign =
	| CustomMasktfromprimaryLiteral
	| `-${CustomMasktfromprimaryLiteral}`
type CustomMasktfromsidebarLiteral = `mask-t-from-sidebar-${CustomRef4}`
type CustomMasktfromsidebarLiteralWithSign =
	| CustomMasktfromsidebarLiteral
	| `-${CustomMasktfromsidebarLiteral}`
type CustomMaskttoaccentLiteral = `mask-t-to-accent-${CustomRef65}`
type CustomMaskttoaccentLiteralWithSign =
	| CustomMaskttoaccentLiteral
	| `-${CustomMaskttoaccentLiteral}`
type CustomMaskttocardLiteral = `mask-t-to-card-${CustomRef66}`
type CustomMaskttocardLiteralWithSign =
	| CustomMaskttocardLiteral
	| `-${CustomMaskttocardLiteral}`
type CustomMaskttochartLiteral = `mask-t-to-chart-${CustomRef67}`
type CustomMaskttochartLiteralWithSign =
	| CustomMaskttochartLiteral
	| `-${CustomMaskttochartLiteral}`
type CustomMaskttodestructiveLiteral = `mask-t-to-destructive-${CustomRef68}`
type CustomMaskttodestructiveLiteralWithSign =
	| CustomMaskttodestructiveLiteral
	| `-${CustomMaskttodestructiveLiteral}`
type CustomMaskttomutedLiteral = `mask-t-to-muted-${CustomRef69}`
type CustomMaskttomutedLiteralWithSign =
	| CustomMaskttomutedLiteral
	| `-${CustomMaskttomutedLiteral}`
type CustomMaskttopopoverLiteral = `mask-t-to-popover-${CustomRef70}`
type CustomMaskttopopoverLiteralWithSign =
	| CustomMaskttopopoverLiteral
	| `-${CustomMaskttopopoverLiteral}`
type CustomMaskttoprimaryLiteral = `mask-t-to-primary-${CustomRef71}`
type CustomMaskttoprimaryLiteralWithSign =
	| CustomMaskttoprimaryLiteral
	| `-${CustomMaskttoprimaryLiteral}`
type CustomMaskttosecondaryLiteral = `mask-t-to-secondary-${CustomRef72}`
type CustomMaskttosecondaryLiteralWithSign =
	| CustomMaskttosecondaryLiteral
	| `-${CustomMaskttosecondaryLiteral}`
type CustomMaskttosidebarLiteral = `mask-t-to-sidebar-${CustomRef4}`
type CustomMaskttosidebarLiteralWithSign =
	| CustomMaskttosidebarLiteral
	| `-${CustomMaskttosidebarLiteral}`
type CustomMaskxfromaccentLiteral = `mask-x-from-accent-${CustomRef73}`
type CustomMaskxfromaccentLiteralWithSign =
	| CustomMaskxfromaccentLiteral
	| `-${CustomMaskxfromaccentLiteral}`
type CustomMaskxfromchartLiteral = `mask-x-from-chart-${CustomRef74}`
type CustomMaskxfromchartLiteralWithSign =
	| CustomMaskxfromchartLiteral
	| `-${CustomMaskxfromchartLiteral}`
type CustomMaskxfromprimaryLiteral = `mask-x-from-primary-${CustomRef75}`
type CustomMaskxfromprimaryLiteralWithSign =
	| CustomMaskxfromprimaryLiteral
	| `-${CustomMaskxfromprimaryLiteral}`
type CustomMaskxfromsidebarLiteral = `mask-x-from-sidebar-${CustomRef4}`
type CustomMaskxfromsidebarLiteralWithSign =
	| CustomMaskxfromsidebarLiteral
	| `-${CustomMaskxfromsidebarLiteral}`
type CustomMaskxtoaccentLiteral = `mask-x-to-accent-${CustomRef76}`
type CustomMaskxtoaccentLiteralWithSign =
	| CustomMaskxtoaccentLiteral
	| `-${CustomMaskxtoaccentLiteral}`
type CustomMaskxtochartLiteral = `mask-x-to-chart-${CustomRef77}`
type CustomMaskxtochartLiteralWithSign =
	| CustomMaskxtochartLiteral
	| `-${CustomMaskxtochartLiteral}`
type CustomMaskxtoprimaryLiteral = `mask-x-to-primary-${CustomRef78}`
type CustomMaskxtoprimaryLiteralWithSign =
	| CustomMaskxtoprimaryLiteral
	| `-${CustomMaskxtoprimaryLiteral}`
type CustomMaskxtosidebarLiteral = `mask-x-to-sidebar-${CustomRef4}`
type CustomMaskxtosidebarLiteralWithSign =
	| CustomMaskxtosidebarLiteral
	| `-${CustomMaskxtosidebarLiteral}`
type CustomMaskyfromaccentLiteral = `mask-y-from-accent-${CustomRef79}`
type CustomMaskyfromaccentLiteralWithSign =
	| CustomMaskyfromaccentLiteral
	| `-${CustomMaskyfromaccentLiteral}`
type CustomMaskyfromchartLiteral = `mask-y-from-chart-${CustomRef80}`
type CustomMaskyfromchartLiteralWithSign =
	| CustomMaskyfromchartLiteral
	| `-${CustomMaskyfromchartLiteral}`
type CustomMaskyfromprimaryLiteral = `mask-y-from-primary-${CustomRef81}`
type CustomMaskyfromprimaryLiteralWithSign =
	| CustomMaskyfromprimaryLiteral
	| `-${CustomMaskyfromprimaryLiteral}`
type CustomMaskyfromsecondaryLiteral = `mask-y-from-secondary-${CustomRef82}`
type CustomMaskyfromsecondaryLiteralWithSign =
	| CustomMaskyfromsecondaryLiteral
	| `-${CustomMaskyfromsecondaryLiteral}`
type CustomMaskyfromsidebarLiteral = `mask-y-from-sidebar-${CustomRef4}`
type CustomMaskyfromsidebarLiteralWithSign =
	| CustomMaskyfromsidebarLiteral
	| `-${CustomMaskyfromsidebarLiteral}`
type CustomMaskytoaccentLiteral = `mask-y-to-accent-${CustomRef83}`
type CustomMaskytoaccentLiteralWithSign =
	| CustomMaskytoaccentLiteral
	| `-${CustomMaskytoaccentLiteral}`
type CustomMaskytochartLiteral = `mask-y-to-chart-${CustomRef84}`
type CustomMaskytochartLiteralWithSign =
	| CustomMaskytochartLiteral
	| `-${CustomMaskytochartLiteral}`
type CustomMaskytoprimaryLiteral = `mask-y-to-primary-${CustomRef85}`
type CustomMaskytoprimaryLiteralWithSign =
	| CustomMaskytoprimaryLiteral
	| `-${CustomMaskytoprimaryLiteral}`
type CustomMaskytosecondaryLiteral = `mask-y-to-secondary-${CustomRef86}`
type CustomMaskytosecondaryLiteralWithSign =
	| CustomMaskytosecondaryLiteral
	| `-${CustomMaskytosecondaryLiteral}`
type CustomMaskytosidebarLiteral = `mask-y-to-sidebar-${CustomRef4}`
type CustomMaskytosidebarLiteralWithSign =
	| CustomMaskytosidebarLiteral
	| `-${CustomMaskytosidebarLiteral}`
type CustomDropshadowaccentLiteral = `drop-shadow-accent-${CustomRef87}`
type CustomDropshadowaccentLiteralWithSign =
	| CustomDropshadowaccentLiteral
	| `-${CustomDropshadowaccentLiteral}`
type CustomDropshadowchartLiteral = `drop-shadow-chart-${CustomRef88}`
type CustomDropshadowchartLiteralWithSign =
	| CustomDropshadowchartLiteral
	| `-${CustomDropshadowchartLiteral}`
type CustomDropshadowprimaryLiteral = `drop-shadow-primary-${CustomRef89}`
type CustomDropshadowprimaryLiteralWithSign =
	| CustomDropshadowprimaryLiteral
	| `-${CustomDropshadowprimaryLiteral}`
type CustomDropshadowsidebarLiteral = `drop-shadow-sidebar-${CustomRef4}`
type CustomDropshadowsidebarLiteralWithSign =
	| CustomDropshadowsidebarLiteral
	| `-${CustomDropshadowsidebarLiteral}`
type CustomFadeinLiteral = `fade-in-${CustomRef90}`
type CustomFadeinLiteralWithSign =
	| CustomFadeinLiteral
	| `-${CustomFadeinLiteral}`
type CustomFadeoutLiteral = `fade-out-${CustomRef90}`
type CustomFadeoutLiteralWithSign =
	| CustomFadeoutLiteral
	| `-${CustomFadeoutLiteral}`
type CustomSlideinfrombottomLiteral =
	| `slide-in-from-bottom-${CustomRef90}`
	| "slide-in-from-bottom-full"
type CustomSlideinfrombottomLiteralWithSign =
	| CustomSlideinfrombottomLiteral
	| `-${CustomSlideinfrombottomLiteral}`
type CustomSlideinfromleftLiteral =
	| `slide-in-from-left-${CustomRef90}`
...
type CustomSlideouttorightLiteral =
	| `slide-out-to-right-${CustomRef90}`
	| "slide-out-to-right-full"
type CustomSlideouttorightLiteralWithSign =
	| CustomSlideouttorightLiteral
	| `-${CustomSlideouttorightLiteral}`
type CustomSlideouttotopLiteral =
	| `slide-out-to-top-${CustomRef90}`
	| "slide-out-to-top-full"
type CustomSlideouttotopLiteralWithSign =
	| CustomSlideouttotopLiteral
	| `-${CustomSlideouttotopLiteral}`
type CustomZoominLiteral = `zoom-in-${CustomRef90}`
type CustomZoominLiteralWithSign =
	| CustomZoominLiteral
	| `-${CustomZoominLiteral}`
type CustomZoomoutLiteral = `zoom-out-${CustomRef90}`
type CustomZoomoutLiteralWithSign =
	| CustomZoomoutLiteral
	| `-${CustomZoomoutLiteral}`
type CustomMaskradialatLiteral = `mask-radial-at-${CustomRef91}`
type CustomMaskradialatLiteralWithSign =
	| CustomMaskradialatLiteral
	| `-${CustomMaskradialatLiteral}`
type CustomMasklinearfromLiteral =
	| `mask-linear-from-${CustomRef92}`
	| "mask-linear-from-card-foreground"
	| "mask-linear-from-destructive-foreground"
	| "mask-linear-from-muted-foreground"
	| "mask-linear-from-popover-foreground"
	| "mask-linear-from-secondary-foreground"
type CustomMasklinearfromLiteralWithSign =
	| CustomMasklinearfromLiteral
	| `-${CustomMasklinearfromLiteral}`
type CustomMaskradialLiteral = `mask-radial-${CustomRef93}`
type CustomMaskradialLiteralWithSign =
	| CustomMaskradialLiteral
	| `-${CustomMaskradialLiteral}`
type CustomMasklinearLiteral = `mask-linear-${CustomRef94}`
type CustomMasklinearLiteralWithSign =
	| CustomMasklinearLiteral
	| `-${CustomMasklinearLiteral}`
type CustomMaskLiteral = `mask-${CustomRef95}`
type CustomMaskLiteralWithSign = CustomMaskLiteral | `-${CustomMaskLiteral}`
type CustomMaskconicfromLiteral =
	| `mask-conic-from-${CustomRef92}`
	| "mask-conic-from-card-foreground"
	| "mask-conic-from-destructive-foreground"
	| "mask-conic-from-muted-foreground"
	| "mask-conic-from-popover-foreground"
	| "mask-conic-from-secondary-foreground"
type CustomMaskconicfromLiteralWithSign =
	| CustomMaskconicfromLiteral
	| `-${CustomMaskconicfromLiteral}`
type CustomMaskconicLiteral = `mask-conic-${CustomRef94}`
type CustomMaskconicLiteralWithSign =
	| CustomMaskconicLiteral
	| `-${CustomMaskconicLiteral}`
type CustomMaskconictoLiteral =
	| `mask-conic-to-${CustomRef92}`
	| "mask-conic-to-card-foreground"
	| "mask-conic-to-destructive-foreground"
	| "mask-conic-to-muted-foreground"
	| "mask-conic-to-popover-foreground"
	| "mask-conic-to-secondary-foreground"
type CustomMaskconictoLiteralWithSign =
	| CustomMaskconictoLiteral
	| `-${CustomMaskconictoLiteral}`
type CustomMasklineartoLiteral =
	| `mask-linear-to-${CustomRef92}`
	| "mask-linear-to-card-foreground"
	| "mask-linear-to-destructive-foreground"
	| "mask-linear-to-muted-foreground"
	| "mask-linear-to-popover-foreground"
	| "mask-linear-to-secondary-foreground"
type CustomMasklineartoLiteralWithSign =
	| CustomMasklineartoLiteral
	| `-${CustomMasklineartoLiteral}`
type CustomMaskbfromLiteral =
	| `mask-b-from-${CustomRef92}`
	| "mask-b-from-card-foreground"
	| "mask-b-from-destructive-foreground"
	| "mask-b-from-muted-foreground"
	| "mask-b-from-popover-foreground"
	| "mask-b-from-secondary-foreground"
type CustomMaskbfromLiteralWithSign =
	| CustomMaskbfromLiteral
	| `-${CustomMaskbfromLiteral}`
type CustomMaskbtoLiteral =
	| `mask-b-to-${CustomRef92}`
	| "mask-b-to-card-foreground"
	| "mask-b-to-destructive-foreground"
	| "mask-b-to-muted-foreground"
	| "mask-b-to-popover-foreground"
	| "mask-b-to-secondary-foreground"
type CustomMaskbtoLiteralWithSign =
	| CustomMaskbtoLiteral
	| `-${CustomMaskbtoLiteral}`
type CustomMasklfromLiteral = `mask-l-from-${CustomRef92}`
type CustomMasklfromLiteralWithSign =
	| CustomMasklfromLiteral
	| `-${CustomMasklfromLiteral}`
type CustomMaskltoLiteral = `mask-l-to-${CustomRef92}`
type CustomMaskltoLiteralWithSign =
	| CustomMaskltoLiteral
	| `-${CustomMaskltoLiteral}`
type CustomMaskrfromLiteral = `mask-r-from-${CustomRef92}`
type CustomMaskrfromLiteralWithSign =
	| CustomMaskrfromLiteral
	| `-${CustomMaskrfromLiteral}`
type CustomMaskrtoLiteral = `mask-r-to-${CustomRef92}`
type CustomMaskrtoLiteralWithSign =
	| CustomMaskrtoLiteral
	| `-${CustomMaskrtoLiteral}`
type CustomMaskradialfromLiteral =
	| `mask-radial-from-${CustomRef92}`
	| "mask-radial-from-card-foreground"
	| "mask-radial-from-destructive-foreground"
	| "mask-radial-from-muted-foreground"
	| "mask-radial-from-popover-foreground"
	| "mask-radial-from-secondary-foreground"
type CustomMaskradialfromLiteralWithSign =
	| CustomMaskradialfromLiteral
	| `-${CustomMaskradialfromLiteral}`
type CustomMaskradialtoLiteral =
	| `mask-radial-to-${CustomRef92}`
	| "mask-radial-to-card-foreground"
	| "mask-radial-to-destructive-foreground"
	| "mask-radial-to-muted-foreground"
	| "mask-radial-to-popover-foreground"
	| "mask-radial-to-secondary-foreground"
type CustomMaskradialtoLiteralWithSign =
	| CustomMaskradialtoLiteral
	| `-${CustomMaskradialtoLiteral}`
type CustomMasktfromLiteral =
	| `mask-t-from-${CustomRef92}`
	| "mask-t-from-card-foreground"
	| "mask-t-from-popover-foreground"
	| "mask-t-from-secondary-foreground"
type CustomMasktfromLiteralWithSign =
	| CustomMasktfromLiteral
	| `-${CustomMasktfromLiteral}`
type CustomMaskttoLiteral = `mask-t-to-${CustomRef92}`
type CustomMaskttoLiteralWithSign =
	| CustomMaskttoLiteral
	| `-${CustomMaskttoLiteral}`
type CustomMaskxfromLiteral =
	| `mask-x-from-${CustomRef92}`
	| "mask-x-from-card-foreground"
	| "mask-x-from-destructive-foreground"
	| "mask-x-from-muted-foreground"
	| "mask-x-from-popover-foreground"
	| "mask-x-from-secondary-foreground"
type CustomMaskxfromLiteralWithSign =
	| CustomMaskxfromLiteral
	| `-${CustomMaskxfromLiteral}`
type CustomMaskxtoLiteral =
	| `mask-x-to-${CustomRef92}`
	| "mask-x-to-card-foreground"
	| "mask-x-to-destructive-foreground"
	| "mask-x-to-muted-foreground"
	| "mask-x-to-popover-foreground"
	| "mask-x-to-secondary-foreground"
type CustomMaskxtoLiteralWithSign =
	| CustomMaskxtoLiteral
	| `-${CustomMaskxtoLiteral}`
type CustomMaskyfromLiteral =
	| `mask-y-from-${CustomRef92}`
	| "mask-y-from-card-foreground"
	| "mask-y-from-destructive-foreground"
	| "mask-y-from-muted-foreground"
	| "mask-y-from-popover-foreground"
type CustomMaskyfromLiteralWithSign =
	| CustomMaskyfromLiteral
	| `-${CustomMaskyfromLiteral}`
type CustomMaskytoLiteral =
	| `mask-y-to-${CustomRef92}`
	| "mask-y-to-card-foreground"
	| "mask-y-to-destructive-foreground"
	| "mask-y-to-muted-foreground"
	| "mask-y-to-popover-foreground"
type CustomMaskytoLiteralWithSign =
	| CustomMaskytoLiteral
	| `-${CustomMaskytoLiteral}`
type CustomDropshadowLiteral = `drop-shadow-${CustomRef96}`
type CustomDropshadowLiteralWithSign =
	| CustomDropshadowLiteral
	| `-${CustomDropshadowLiteral}`
type CustomFadeLiteral = `fade-${CustomRef97}`
type CustomFadeLiteralWithSign = CustomFadeLiteral | `-${CustomFadeLiteral}`
type CustomSlideinfromLiteral = `slide-in-from-${CustomRef98}`
type CustomSlideinfromLiteralWithSign =
	| CustomSlideinfromLiteral
	| `-${CustomSlideinfromLiteral}`
type CustomSlideouttoLiteral = `slide-out-to-${CustomRef99}`
type CustomSlideouttoLiteralWithSign =
	| CustomSlideouttoLiteral
	| `-${CustomSlideouttoLiteral}`
type CustomZoomLiteral = `zoom-${CustomRef100}`
type CustomZoomLiteralWithSign = CustomZoomLiteral | `-${CustomZoomLiteral}`
type CustomValue =
	| "spin-in"
	| "spin-out"
	| CustomMaskconicfromaccentLiteralWithSign
	| CustomMaskconicfromchartLiteralWithSign
	| CustomMaskconicfromprimaryLiteralWithSign
	| CustomMaskconicfromsidebarLiteralWithSign
	| CustomMaskconictoaccentLiteralWithSign
	| CustomMaskconictochartLiteralWithSign
	| CustomMaskconictoprimaryLiteralWithSign
	| CustomMaskconictosidebarLiteralWithSign
	| CustomMasklinearfromaccentLiteralWithSign
	| CustomMasklinearfromchartLiteralWithSign
	| CustomMasklinearfromprimaryLiteralWithSign
	| CustomMasklinearfromsidebarLiteralWithSign
	| CustomMasklineartoaccentLiteralWithSign
	| CustomMasklineartochartLiteralWithSign
	| CustomMasklineartoprimaryLiteralWithSign
	| CustomMasklineartosidebarLiteralWithSign
	| CustomMaskbfromaccentLiteralWithSign
	| CustomMaskbfromchartLiteralWithSign
	| CustomMaskbfromprimaryLiteralWithSign
	| CustomMaskbfromsidebarLiteralWithSign
	| CustomMaskbtoaccentLiteralWithSign
	| CustomMaskbtochartLiteralWithSign
	| CustomMaskbtoprimaryLiteralWithSign
	| CustomMaskbtosidebarLiteralWithSign
	| CustomMasklfromaccentLiteralWithSign
	| CustomMasklfromcardLiteralWithSign
	| CustomMasklfromchartLiteralWithSign
	| CustomMasklfromdestructiveLiteralWithSign
	| CustomMasklfrommutedLiteralWithSign
	| CustomMasklfrompopoverLiteralWithSign
	| CustomMasklfromprimaryLiteralWithSign
	| CustomMasklfromsecondaryLiteralWithSign
	| CustomMasklfromsidebarLiteralWithSign
	| CustomMaskltoaccentLiteralWithSign
	| CustomMaskltocardLiteralWithSign
	| CustomMaskltochartLiteralWithSign
	| CustomMaskltodestructiveLiteralWithSign
	| CustomMaskltomutedLiteralWithSign
	| CustomMaskltopopoverLiteralWithSign
	| CustomMaskltoprimaryLiteralWithSign
	| CustomMaskltosecondaryLiteralWithSign
	| CustomMaskltosidebarLiteralWithSign
	| CustomMaskrfromaccentLiteralWithSign
	| CustomMaskrfromcardLiteralWithSign
	| CustomMaskrfromchartLiteralWithSign
	| CustomMaskrfromdestructiveLiteralWithSign
	| CustomMaskrfrommutedLiteralWithSign
	| CustomMaskrfrompopoverLiteralWithSign
	| CustomMaskrfromprimaryLiteralWithSign
	| CustomMaskrfromsecondaryLiteralWithSign
	| CustomMaskrfromsidebarLiteralWithSign
	| CustomMaskrtoaccentLiteralWithSign
	| CustomMaskrtocardLiteralWithSign
	| CustomMaskrtochartLiteralWithSign
	| CustomMaskrtodestructiveLiteralWithSign
	| CustomMaskrtomutedLiteralWithSign
	| CustomMaskrtopopoverLiteralWithSign
	| CustomMaskrtoprimaryLiteralWithSign
	| CustomMaskrtosecondaryLiteralWithSign
	| CustomMaskrtosidebarLiteralWithSign
	| CustomMaskradialatbottomLiteralWithSign
	| CustomMaskradialattopLiteralWithSign
	| CustomMaskradialfromaccentLiteralWithSign
	| CustomMaskradialfromchartLiteralWithSign
	| CustomMaskradialfromprimaryLiteralWithSign
	| CustomMaskradialfromsidebarLiteralWithSign
	| CustomMaskradialtoaccentLiteralWithSign
	| CustomMaskradialtochartLiteralWithSign
	| CustomMaskradialtoprimaryLiteralWithSign
	| CustomMaskradialtosidebarLiteralWithSign
	| CustomMasktfromaccentLiteralWithSign
	| CustomMasktfromchartLiteralWithSign
	| CustomMasktfromdestructiveLiteralWithSign
	| CustomMasktfrommutedLiteralWithSign
	| CustomMasktfromprimaryLiteralWithSign
	| CustomMasktfromsidebarLiteralWithSign
	| CustomMaskttoaccentLiteralWithSign
	| CustomMaskttocardLiteralWithSign
	| CustomMaskttochartLiteralWithSign
	| CustomMaskttodestructiveLiteralWithSign
	| CustomMaskttomutedLiteralWithSign
	| CustomMaskttopopoverLiteralWithSign
	| CustomMaskttoprimaryLiteralWithSign
	| CustomMaskttosecondaryLiteralWithSign
	| CustomMaskttosidebarLiteralWithSign
	| CustomMaskxfromaccentLiteralWithSign
	| CustomMaskxfromchartLiteralWithSign
	| CustomMaskxfromprimaryLiteralWithSign
	| CustomMaskxfromsidebarLiteralWithSign
	| CustomMaskxtoaccentLiteralWithSign
	| CustomMaskxtochartLiteralWithSign
	| CustomMaskxtoprimaryLiteralWithSign
	| CustomMaskxtosidebarLiteralWithSign
	| CustomMaskyfromaccentLiteralWithSign
	| CustomMaskyfromchartLiteralWithSign
	| CustomMaskyfromprimaryLiteralWithSign
	| CustomMaskyfromsecondaryLiteralWithSign
	| CustomMaskyfromsidebarLiteralWithSign
	| CustomMaskytoaccentLiteralWithSign
	| CustomMaskytochartLiteralWithSign
	| CustomMaskytoprimaryLiteralWithSign
	| CustomMaskytosecondaryLiteralWithSign
	| CustomMaskytosidebarLiteralWithSign
	| CustomDropshadowaccentLiteralWithSign
	| CustomDropshadowchartLiteralWithSign
	| CustomDropshadowprimaryLiteralWithSign
	| CustomDropshadowsidebarLiteralWithSign
	...
	| CustomMaskradialatLiteralWithSign
	| CustomMasklinearfromLiteralWithSign
	| CustomMaskradialLiteralWithSign
	| CustomMasklinearLiteralWithSign
	| CustomMaskLiteralWithSign
	| CustomMaskconicfromLiteralWithSign
	| CustomMaskconicLiteralWithSign
	| CustomMaskconictoLiteralWithSign
	| CustomMasklineartoLiteralWithSign
	| CustomMaskbfromLiteralWithSign
	| CustomMaskbtoLiteralWithSign
	| CustomMasklfromLiteralWithSign
	| CustomMaskltoLiteralWithSign
	| CustomMaskrfromLiteralWithSign
	| CustomMaskrtoLiteralWithSign
	| CustomMaskradialfromLiteralWithSign
	| CustomMaskradialtoLiteralWithSign
	| CustomMasktfromLiteralWithSign
	| CustomMaskttoLiteralWithSign
	| CustomMaskxfromLiteralWithSign
	| CustomMaskxtoLiteralWithSign
	| CustomMaskyfromLiteralWithSign
	| CustomMaskytoLiteralWithSign
	| CustomDropshadowLiteralWithSign
...
type BorderWidthBorderdestructiveLiteral =
	`border-destructive-${BorderWidthRef5}`
...
type BorderWidthBordermutedLiteral = `border-muted-${BorderWidthRef6}`
type BorderWidthBorderpopoverLiteral = `border-popover-${BorderWidthRef7}`
type BorderWidthBorderprimaryLiteral = `border-primary-${BorderWidthRef8}`
...
type BorderWidthBordersecondaryLiteral = `border-secondary-${BorderWidthRef9}`
...
type BorderWidthDividexLiteral = `divide-x-${BorderWidthRef10}`
type BorderWidthDivideyLiteral = `divide-y-${BorderWidthRef11}`
type BorderWidthBorderLiteral = `border-${BorderWidthRef12}`
...
type BorderWidthDivideLiteral = `divide-${BorderWidthRef13}`
type BorderWidthValue =
	...
	| BorderWidthBorderdestructiveLiteral
...
type BoxShadowRingdestructiveLiteral = `ring-destructive-${BoxShadowRef5}`
type BoxShadowRingmutedLiteral = `ring-muted-${BoxShadowRef6}`
type BoxShadowRingoffsetLiteral =
	| `ring-offset-${BoxShadowRef7}`
	| "ring-offset-0"
	| "ring-offset-1"
	| "ring-offset-2"
	| "ring-offset-4"
...
type BoxShadowRingpopoverLiteral = `ring-popover-${BoxShadowRef8}`
type BoxShadowRingprimaryLiteral = `ring-primary-${BoxShadowRef9}`
type BoxShadowRingsecondaryLiteral = `ring-secondary-${BoxShadowRef10}`
type BoxShadowRingsidebarLiteral = `ring-sidebar-${BoxShadowRef7}`
type BoxShadowShadowaccentLiteral = `shadow-accent-${BoxShadowRef11}`
type BoxShadowShadowcardLiteral = `shadow-card-${BoxShadowRef12}`
type BoxShadowShadowchartLiteral = `shadow-chart-${BoxShadowRef13}`
type BoxShadowShadowdestructiveLiteral = `shadow-destructive-${BoxShadowRef14}`
type BoxShadowShadowmutedLiteral = `shadow-muted-${BoxShadowRef15}`
type BoxShadowShadowpopoverLiteral = `shadow-popover-${BoxShadowRef16}`
type BoxShadowShadowprimaryLiteral = `shadow-primary-${BoxShadowRef17}`
type BoxShadowShadowsecondaryLiteral = `shadow-secondary-${BoxShadowRef18}`
type BoxShadowShadowsidebarLiteral = `shadow-sidebar-${BoxShadowRef7}`
type BoxShadowRingLiteral = `ring-${BoxShadowRef19}`
type BoxShadowShadowLiteral = `shadow-${BoxShadowRef20}`
type BoxShadowValue =
	| "ring"
	| "shadow"
	...
	| BoxShadowRingdestructiveLiteral
	...
	| BoxShadowShadowdestructiveLiteral
...
type MaskImageValue = "mask-none" | "mask-none"
...
type AnimationPlayStateValue = "paused" | "running" | "paused" | "running"
...
type ColorTextshadowLiteral =
	| `text-shadow-${ColorRef4}`
	| "text-shadow-2xs"
	...
	| "text-shadow-destructive-foreground"
	...
	| "text-shadow-popover"
	| "text-shadow-popover-foreground"
	...
	| "text-shadow-secondary-foreground"
	| "text-shadow-sidebar"
	| "text-shadow-sidebar-accent"
	| "text-shadow-sidebar-accent-foreground"
	| "text-shadow-sidebar-border"
	| "text-shadow-sidebar-foreground"
	| "text-shadow-sidebar-primary"
	| "text-shadow-sidebar-primary-foreground"
	| "text-shadow-sidebar-ring"
	| "text-shadow-sky-50"
	| "text-shadow-sky-100"
	| "text-shadow-sky-200"
	| "text-shadow-sky-300"
